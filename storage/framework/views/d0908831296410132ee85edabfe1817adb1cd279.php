...
<section class="container">
    <ul class="nav nav-tabs">
        <li class="active">
            <a><?php echo e(__('label.now')); ?></a>
        </li>
        <li>
            <a href="<?php echo e(('comming-soon')); ?>"><?php echo e(__('label.soon')); ?></a>
        </li>
    </ul>
    <div class="col-sm-12">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wampp\www\vexemphim\resources\views\frontend\movie\now-showing.blade.php ENDPATH**/ ?>